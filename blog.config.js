...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yueyueyu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.yueyueyu.one', // 网站地址
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/Pio.model2.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
